  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none" style={{ opacity: 0.4 }}>
        ...
        {/* Symbols */}
        <div className="absolute top-56 right-1/3 w-6 h-6 border border-black bg-coral flex items-center justify-center text-black font-bold text-sm">
          🚫
        </div>
        <div className="absolute bottom-56 left-1/3 w-6 h-6 border border-black bg-blue-gaming flex items-center justify-center text-black font-bold text-sm">
          ×
        </div>
      ...
      <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
        ...
        <div className="mb-12 animate-fade-in-up">
          ...
          <p className="text-xl lg:text-2xl text-black mb-8">Oops! You don't have permission to enter this room! 🚪</p>
        </div>

        {/* Fun Message */}
        <div
          className="bg-white border border-black rounded-lg p-8 mb-12 relative animate-fade-in-up"
          style={{ animationDelay: '0.2s' }}
        >
          <div className="text-6xl mb-4 animate-bounce">🚫</div>
          <h2 className="text-3xl font-bold mb-4 text-black">This room is members only!</h2>
          <p className="text-lg text-black mb-6">
            Looks like you need a special invitation to join this Bit9o game. Don't worry, it's not personal - we just
            want to keep the game fair and fun for everyone!
          </p>
