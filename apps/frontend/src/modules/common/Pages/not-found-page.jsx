    ...
    >
      ...
      <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
        ...
        <div className="mb-12 animate-fade-in-up">
          ...
          <p className="text-xl lg:text-2xl text-black mb-8">Looks like this page went missing! 🎮</p>
        </div>
        ...
        <div className="mt-16 text-black">
          <p className="text-sm font-bold">Remember: In Bit9o, every number matters - but this page? Not so much! 😄</p>
        </div>
      </div>
    </div>
  );
